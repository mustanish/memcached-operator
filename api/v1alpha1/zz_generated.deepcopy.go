...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OperatorConstant) DeepCopyInto(out *OperatorConstant) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OperatorConstant.
func (in *OperatorConstant) DeepCopy() *OperatorConstant {
	if in == nil {
		return nil
	}
	out := new(OperatorConstant)
	in.DeepCopyInto(out)
	return out
}
